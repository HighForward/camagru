...
create table likes (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, post_id int, user_id int, FOREIGN KEY (post_id) REFERENCES posts(id), FOREIGN KEY (user_id) REFERENCES users(id));